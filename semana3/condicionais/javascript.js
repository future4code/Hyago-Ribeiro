...
//O CÓDIGO ESTÁ COMENTADO, PORQUE ESTAVA DANDO CONFLITO NA HORA DE RODAR O CÓDIGO, PORQUE ELE JÁ TEM UM ERRO.
...
//EXERCÍCIO 4
let nuumero1 = prompt('Digite um número')
const valor1 = Number(nuumero1)
let nuumero2 = prompt('Digite outro número')
const valor2 = Number(nuumero2)
let nuumero3 = prompt('Digite mais um número')
const valor3 = Number(nuumero3)
...
let vertebrado = prompt("Ele é vertebrado?")
  ...
  if(vertebrado === "sim"){
    ...
    let pelos = prompt("Ele possuí pelos?")
      if(pelos === "sim"){
        
        let racional = prompt("Ele é racional?")
        if(racional === "sim"){
          console.log('O animal ' + animal + ' é um humano')
        }else{
          console.log('O animal ' + animal + ' é um mamifero não humano')
        }

      }else{
        
        let penas = prompt("Ele possuí penas?")
        ...
        if(penas === "sim"){
          ...
          if(terrestre === "sim"){
            ...
            let parteDaVidaNaAgua = prompt("Ele fica parte da vida na água?")
            if(parteDaVidaNaAgua === "sim"){

              console.log('O animal ' + animal + ' é um anfibio')

            }else{
              console.log('O animal ' + animal + ' é um reptil')
            }
